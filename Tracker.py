...
if __name__=='__main__':
    ...
    while True:
        ...
        if ret_val:
            ...
            img=cv2.line(frame, (1200, 300), (100, 300), (0, 255, 0), 3)
            img=cv2.line(img, (1200, 400), (100, 400), (0, 255, 0), 3)
            img=cv2.line(img, (1200, 500), (100, 500), (0, 255, 0), 3)
            img=cv2.line(img, (1200, 600), (100, 600), (0, 255, 0), 3)
            img=cv2.line(img, (1200, 700), (100, 700), (0, 255, 0), 3)

            img=cv2.line(img, (100, 700), (100, 300), (0, 255, 0), 3)
            img=cv2.line(img, (200, 700), (200, 300), (0, 255, 0), 3)
            img=cv2.line(img, (300, 700), (300, 300), (0, 255, 0), 3)
            img=cv2.line(img, (400, 700), (400, 300), (0, 255, 0), 3)
            img=cv2.line(img, (500, 700), (500, 300), (0, 255, 0), 3)
            img=cv2.line(img, (600, 700), (600, 300), (0, 255, 0), 3)
            img=cv2.line(img, (700, 700), (700, 300), (0, 255, 0), 3)
            img=cv2.line(img, (800, 700), (800, 300), (0, 255, 0), 3)
            img=cv2.line(img, (900, 700), (900, 300), (0, 255, 0), 3)
            img=cv2.line(img, (1000, 700), (1000, 300), (0, 255, 0), 3)
            img=cv2.line(img, (1100, 700), (1100, 300), (0, 255, 0), 3)
            img=cv2.line(img, (1200, 700), (1200, 300), (0, 255, 0), 3)
