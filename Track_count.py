...
def draw_lines(lines, img):
    for line in lines:
        img = cv2.line(img, line['Cords'][0], line['Cords'][1], line['Cords'][2], line['Cords'][3], line['Cords'][4], line['Cords'][5], line['Cords'][6], line['Cords'][7], line['Cords'][8], line['Cords'][9], line['Cords'][10], line['Cords'][11], line['Cords'][12], line['Cords'][13], line['Cords'][14], line['Cords'][15], line['Cords'][16], (255,255,255), 3)
    return img
